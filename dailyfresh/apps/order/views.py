...
class OrderPayView(View):
    ...
    def post(self, request):
        ...
        # 初始化
        app_private_key_string = open(os.path.join(os.path.dirname(__file__), './app_private_key.pem')).read()
        alipay_public_key_string = open(os.path.join(os.path.dirname(__file__), './alipay_public_key.pem')).read()
        alipay = AliPay(
            appid="2016101600697826",  # 应用id
